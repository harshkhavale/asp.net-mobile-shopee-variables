...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <div class=" mt-4 w-100 sticky-top" style="font-family: 'Quicksand', sans-serif;z-index:2">
    ...
    <button class="carousel-control-next" type="button" data-bs-target="#myCarousel" data-bs-slide="next">
      ...
      <span class="visually-hidden">Next</span>
       ...
       <div class="my-2 px-4 rounded-4 bg-light shadow-lg sticky-top" style="font-family: 'Quicksand', sans-serif;z-index:3;">
                                                       <h5 style="font-size:large" class="badge bg-success my-2 ">NEW ARRIVAL'S</h5>
                                                                                    <a href="DefaultAllProducts.aspx" class="text-center h4 mx-4 link-primary">VIEW ALL ></a>
<br />
